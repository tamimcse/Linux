gst-launch-1.0 videotestsrc pattern=snow num-buffers=900 ! video/x-raw, framerate=30/1, width=1024, height=680 ! x264enc bitrate=2048 ! tcpserversink host=$1 port=8554 &
