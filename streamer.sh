gst-launch-1.0 videotestsrc pattern=snow num-buffers=900 ! video/x-raw, framerate=30/1, width=512, height=340 ! x264enc bitrate=512 ! tcpserversink host=$1 port=8554 &
