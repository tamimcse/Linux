	...
	rcu_read_lock();
        ...
        for (i = 0; i < sizeof(arr)/sizeof(arr[0]); i++) {
            for (j = 0; j < 200; j++) {
                ...
                if (dev) {
                    pr_err("PPC[%d]=%llu !!!!!", i, (end2-start2 - cost_of_tsc));
                }
            }
