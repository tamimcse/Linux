...
#	net[host].cmd( 'tc -s qdisc show dev {0}-eth0'.format(host))
    ...
    for router in ['r1']:    	
	net[router].cmd( 'tc qdisc add dev {0}-eth1 root handle 1: mf'.format(router))
	net[router].cmd( 'tc qdisc add dev {0}-eth1 parent 1: handle 2: htb default 10'.format(router))
	...
	net[ 'h1' ].cmd( 'sudo python streamer.py 172.16.101.1 &' )
	net[ 'h2' ].cmd( 'sh streaming.sh 172.16.101.1' )
	net[ 'h3' ].cmd( 'sudo python streamer.py 172.16.103.1 &' )
	net[ 'h4' ].cmd( 'sh streaming.sh 172.16.103.1' )
	net[ 'h5' ].cmd( 'sudo python streamer.py 172.16.105.1 &' )
